...
CREATE TABLE `t_optimizer` (
  ...
  PRIMARY KEY (`source_se`,`dest_se`, `vo_name`, `activity`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_optimizer_evolution` (
  ...
  KEY `idx_optimizer_evolution` (`source_se`, `dest_se`, `vo_name`, `activity`, `datetime`),
  KEY `idx_datetime` (`datetime`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_tcn_atm_resource_ctrlspec` (
  `src_se` varchar(50) NOT NULL,
  `dst_se` varchar(50) NOT NULL,
  `vo_name` varchar(50) NOT NULL,
  `activity` varchar(255) NOT NULL,
  `resc_id` varchar(64) NOT NULL,
  `min_share` double DEFAULT NULL,
  PRIMARY KEY (`src_se`,`dst_se`, `vo_name`, `activity`, `resc_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `t_tcn_resource_capacity`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_tcn_resource_capacity` (
  `resc_id` varchar(64) NOT NULL,
  `capacity` double DEFAULT 100.0, 
  PRIMARY KEY (`resc_id`, `capacity`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;  